...
from system_prompt_langchain import SYSTEM_PROMPT
...
DOCUMENT_URL = "https://raw.githubusercontent.com/langchain-ai/langchain/refs/heads/master/README.md"
DOCUMENT_PATH = os.path.join(os.path.dirname(__file__), "langchain.md")
